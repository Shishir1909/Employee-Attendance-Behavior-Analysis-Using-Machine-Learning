...
required_schema_text = ", ".join(REQUIRED_COLUMNS)
optional_schema_text = ", ".join(OPTIONAL_GROUND_TRUTH_COLUMNS)
with st.expander("Required CSV Schema"):
    st.markdown("**Required columns**")
    st.code(required_schema_text, language="text")
    st.markdown("**Optional columns (enables ground-truth evaluation)**")
    st.code(optional_schema_text, language="text")
